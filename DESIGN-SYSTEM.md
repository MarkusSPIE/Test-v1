...
## Layout pattern (floating toolbox window)

- **Title bar**: solid navy (`#003772`) background, white bold text for the product name, small
  circular red (`#E31C18`) accent dot to the left of the title (echoes the logo's sun icon),
